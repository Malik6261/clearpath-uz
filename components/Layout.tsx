...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-50 font-sans text-stone-900">
      ...
      <section className="bg-stone-900 py-12 border-t border-stone-800">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-4">
          <h3 className="text-xl md:text-2xl font-bold text-white flex items-center justify-center gap-2">
            <span>📱</span> Telegramda ham ishlaydi
          </h3>
          <p className="text-stone-400 text-sm md:text-base">
            ClearPath botini Telegram orqali ham ishlatishingiz mumkin
          </p>
          <div className="pt-2">
            <a 
              href="https://t.me/clearpathuz_bot" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-stone-900 rounded-full font-bold text-sm hover:bg-stone-200 transition-colors"
            >
      ...
      <footer id="footer" className="bg-stone-900 text-stone-500 py-12 border-t border-stone-800">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-10">
          <div className="space-y-2">
            <h4 className="text-sm font-bold text-stone-300 uppercase tracking-widest">
              Grant va stipendiya topishda yordam kerakmi?
            </h4>
            <div className="text-xs font-bold tracking-tighter text-stone-500">
              ClearPath — clearpath.uz © 2026
            </div>
          </div>
          
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-4">
            <a href="https://t.me/malik_labs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors text-xs font-medium">
            ...
            >
              {copied ? (
                <span className="text-emerald-400 flex items-center gap-1">✓ Nusxa olindi</span>
              ) : (
                <>
